...
{
	Character.WizardAttack[0] = GetPrivateProfileInt("Character","SM.RightDamageMin",6,CFG_CHARACTER);
	Character.WizardAttack[1] = GetPrivateProfileInt("Character","SM.RightDamageMax",4,CFG_CHARACTER);
	Character.WizardAttack[2] = GetPrivateProfileInt("Character","SM.LeftDamageMin",6,CFG_CHARACTER);
	Character.WizardAttack[3] = GetPrivateProfileInt("Character","SM.LeftDamageMax",4,CFG_CHARACTER);
	Character.AttackSpeed[0] = GetPrivateProfileInt("Character","SM.AttackSpeed",15,CFG_CHARACTER);
	Character.MagicSpeed[0] = GetPrivateProfileInt("Character","SM.MagicSpeed",20,CFG_CHARACTER);
	Character.Defense[0] = GetPrivateProfileInt("Character","SM.Defense",4,CFG_CHARACTER);
	Character.SuccessfulBlocking[0] = GetPrivateProfileInt("Character","SM.SuccessfulBlocking",3,CFG_CHARACTER);
	Character.MagicDamageMin[0] = GetPrivateProfileInt("Character","SM.MagicDamageMin",9,CFG_CHARACTER);
	Character.MagicDamageMax[0] = GetPrivateProfileInt("Character","SM.MagicDamageMax",4,CFG_CHARACTER);

	Character.KnightAttack[0] = GetPrivateProfileInt("Character","BK.RightDamageMin",6,CFG_CHARACTER);
	Character.KnightAttack[1] = GetPrivateProfileInt("Character","BK.RightDamageMax",4,CFG_CHARACTER);
	Character.KnightAttack[2] = GetPrivateProfileInt("Character","BK.LeftDamageMin",6,CFG_CHARACTER);
	Character.KnightAttack[3] = GetPrivateProfileInt("Character","BK.LeftDamageMax",4,CFG_CHARACTER);
	Character.AttackSpeed[1] = GetPrivateProfileInt("Character","BK.AttackSpeed",15,CFG_CHARACTER);
	Character.MagicSpeed[1] = GetPrivateProfileInt("Character","BK.MagicSpeed",20,CFG_CHARACTER);
	Character.Defense[1] = GetPrivateProfileInt("Character","BK.Defense",3,CFG_CHARACTER);
	Character.SuccessfulBlocking[1] = GetPrivateProfileInt("Character","BK.SuccessfulBlocking",3,CFG_CHARACTER);
	Character.MagicDamageMin[1] = GetPrivateProfileInt("Character","BK.MagicDamageMin",9,CFG_CHARACTER);
	Character.MagicDamageMax[1] = GetPrivateProfileInt("Character","BK.MagicDamageMax",4,CFG_CHARACTER);

	Character.ElfAttack[0] = GetPrivateProfileInt("Character","ME.RightDamageMin",7,CFG_CHARACTER);
	Character.ElfAttack[1] = GetPrivateProfileInt("Character","ME.RightDamageMax",4,CFG_CHARACTER);
	Character.ElfAttack[2] = GetPrivateProfileInt("Character","ME.LeftDamageMin",7,CFG_CHARACTER);
	Character.ElfAttack[3] = GetPrivateProfileInt("Character","ME.LeftDamageMax",4,CFG_CHARACTER);
	Character.ElfAttack[4] = GetPrivateProfileInt("Character","ME.RightDamageMin2",7,CFG_CHARACTER);
	Character.ElfAttack[5] = GetPrivateProfileInt("Character","ME.RightDamageMax2",4,CFG_CHARACTER);
	Character.ElfAttack[6] = GetPrivateProfileInt("Character","ME.LeftDamageMin2",7,CFG_CHARACTER);
	Character.ElfAttack[7] = GetPrivateProfileInt("Character","ME.LeftDamageMax2",4,CFG_CHARACTER);
	Character.ElfAttack[8] = GetPrivateProfileInt("Character","ME.RightDamageMin3",14,CFG_CHARACTER);
	Character.ElfAttack[9] = GetPrivateProfileInt("Character","ME.RightDamageMax3",8,CFG_CHARACTER);
	Character.ElfAttack[10] = GetPrivateProfileInt("Character","ME.LeftDamageMin3",14,CFG_CHARACTER);
	Character.ElfAttack[11] = GetPrivateProfileInt("Character","ME.LeftDamageMax3",8,CFG_CHARACTER);
	Character.ElfAttack[12] = GetPrivateProfileInt("Character","ME.RightDamageMin4",7,CFG_CHARACTER);
	Character.ElfAttack[13] = GetPrivateProfileInt("Character","ME.RightDamageMax4",4,CFG_CHARACTER);
	Character.ElfAttack[14] = GetPrivateProfileInt("Character","ME.LeftDamageMin4",7,CFG_CHARACTER);
	Character.ElfAttack[15] = GetPrivateProfileInt("Character","ME.LeftDamageMax4",4,CFG_CHARACTER);
	Character.AttackSpeed[2] = GetPrivateProfileInt("Character","ME.AttackSpeed",50,CFG_CHARACTER);
	Character.MagicSpeed[2] = GetPrivateProfileInt("Character","ME.MagicSpeed",50,CFG_CHARACTER);
	Character.Defense[2] = GetPrivateProfileInt("Character","ME.Defense",10,CFG_CHARACTER);
	Character.SuccessfulBlocking[2] = GetPrivateProfileInt("Character","ME.SuccessfulBlocking",4,CFG_CHARACTER);
	Character.MagicDamageMin[2] = GetPrivateProfileInt("Character","ME.MagicDamageMin",9,CFG_CHARACTER);
	Character.MagicDamageMax[2] = GetPrivateProfileInt("Character","ME.MagicDamageMax",4,CFG_CHARACTER);

	Character.GladiatorAttack[0] = GetPrivateProfileInt("Character","MG.RightDamageMin",6,CFG_CHARACTER);
	Character.GladiatorAttack[1] = GetPrivateProfileInt("Character","MG.RightDamageMax",4,CFG_CHARACTER);
	Character.GladiatorAttack[2] = GetPrivateProfileInt("Character","MG.LeftDamageMin",6,CFG_CHARACTER);
	Character.GladiatorAttack[3] = GetPrivateProfileInt("Character","MG.LeftDamageMax",4,CFG_CHARACTER);
	Character.GladiatorAttack[4] = GetPrivateProfileInt("Character","MG.RightDamageMin2",12,CFG_CHARACTER);
	Character.GladiatorAttack[5] = GetPrivateProfileInt("Character","MG.RightDamageMax2",8,CFG_CHARACTER);
	Character.GladiatorAttack[6] = GetPrivateProfileInt("Character","MG.LeftDamageMin2",12,CFG_CHARACTER);
	Character.GladiatorAttack[7] = GetPrivateProfileInt("Character","MG.LeftDamageMax2",8,CFG_CHARACTER);
	Character.AttackSpeed[3] = GetPrivateProfileInt("Character","MG.AttackSpeed",15,CFG_CHARACTER);
	Character.MagicSpeed[3] = GetPrivateProfileInt("Character","MG.MagicSpeed",20,CFG_CHARACTER);
	Character.Defense[3] = GetPrivateProfileInt("Character","MG.Defense",4,CFG_CHARACTER);
	Character.SuccessfulBlocking[3] = GetPrivateProfileInt("Character","MG.SuccessfulBlocking",3,CFG_CHARACTER);
	Character.MagicDamageMin[3] = GetPrivateProfileInt("Character","MG.MagicDamageMin",9,CFG_CHARACTER);
	Character.MagicDamageMax[3] = GetPrivateProfileInt("Character","MG.MagicDamageMax",4,CFG_CHARACTER);

	Character.LordAttack[0] = GetPrivateProfileInt("Character","DL.RightDamageMin",7,CFG_CHARACTER);
	Character.LordAttack[1] = GetPrivateProfileInt("Character","DL.RightDamageMax",5,CFG_CHARACTER);
	Character.LordAttack[2] = GetPrivateProfileInt("Character","DL.LeftDamageMin",7,CFG_CHARACTER);
	Character.LordAttack[3] = GetPrivateProfileInt("Character","DL.LeftDamageMax",5,CFG_CHARACTER);
	Character.LordAttack[4] = GetPrivateProfileInt("Character","DL.RightDamageMin2",14,CFG_CHARACTER);
	Character.LordAttack[5] = GetPrivateProfileInt("Character","DL.RightDamageMax2",10,CFG_CHARACTER);
	Character.LordAttack[6] = GetPrivateProfileInt("Character","DL.LeftDamageMin2",14,CFG_CHARACTER);
	Character.LordAttack[7] = GetPrivateProfileInt("Character","DL.LeftDamageMax2",10,CFG_CHARACTER);
	Character.AttackSpeed[4] = GetPrivateProfileInt("Character","DL.AttackSpeed",10,CFG_CHARACTER);
	Character.MagicSpeed[4] = GetPrivateProfileInt("Character","DL.MagicSpeed",10,CFG_CHARACTER);
	Character.Defense[4] = GetPrivateProfileInt("Character","DL.Defense",7,CFG_CHARACTER);
	Character.SuccessfulBlocking[4] = GetPrivateProfileInt("Character","DL.SuccessfulBlocking",7,CFG_CHARACTER);
	Character.MagicDamageMin[4] = GetPrivateProfileInt("Character","DL.MagicDamageMin",9,CFG_CHARACTER);
	Character.MagicDamageMax[4] = GetPrivateProfileInt("Character","DL.MagicDamageMax",4,CFG_CHARACTER);
}
...
void CBalancer::gObjCalCharacter(int aIndex)
{
	...
	{
		gObj[aIndex].m_DetectSpeedHackTime = (int)(*(DWORD*)(0x628E34) - (gObj[aIndex].m_MagicSpeed * 2 * *(float*)(0x628E3C)));
	}
	else
	{
		gObj[aIndex].m_DetectSpeedHackTime = (int)(*(DWORD*)(0x628E34) - (gObj[aIndex].m_AttackSpeed *  *(float*)(0x628E3C)));
	}

	if (gObj[aIndex].m_DetectSpeedHackTime < *(int*)(0x628E40))
	{
		gObj[aIndex].m_DetectSpeedHackTime = *(int*)(0x628E40);
	}
