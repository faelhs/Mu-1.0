...
#define CFG_Quest_Item_Reward		"../DKData/Quests/Quest_Main_Item_Reward.ini"
#define CFG_QuestBoss_Item_Reward	"../DKData/Quests/Quest_Boss_Item_Reward.ini"
#define CFG_QuestLoot_Item_Reward	"../DKData/Quests/Quest_Loot_Item_Reward.ini"
